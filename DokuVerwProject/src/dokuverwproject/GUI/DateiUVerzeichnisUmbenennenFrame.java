...
public class DateiUVerzeichnisUmbenennenFrame extends javax.swing.JFrame {
    ...
    public DateiUVerzeichnisUmbenennenFrame(String selectedRowPath, ThemengruppeFrame tgf, Themengruppe tg) {
        ...
        this.f = new File(this.selectedRowPath);
        if(!f.exists()) return;
    ...
    private void initComponents() {
        ...
        setTitle("Datei / Verzeichnis umbenennen");
        setAlwaysOnTop(true);
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dokuverwproject/IMG/rename.png"))); // NOI18N
        jLabel1.setText("Datei / Verzeichnis umbenennen");
